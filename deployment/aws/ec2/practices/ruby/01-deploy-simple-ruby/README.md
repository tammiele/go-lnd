...
![Search EC2 service](./assets/search_ec2.png)

- Find the **Launch instance** button
![Launch instance](./assets/launch_instance_button.png)
...
![Application Name and OS for instance](./assets/name_and_os.png)
...
![Instance type](./assets/instane_type.png)
...
![New key pair](./assets/new_key.png)
...
- AWS EC2 allow us connect to our instance by SSH connection. We need 3 things to SSH to our instance: a **key file**, **instance identification** and an **username** in that instance.
  ...
  ![Instance summary](./assets/insance_summary.png)
...
![SSH successfull](./assets/ssh_success.png)
...
sudo ruby app.rb
```
![Start app](./assets/start_app.png)
